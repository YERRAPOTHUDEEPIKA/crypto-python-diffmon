...
def on_message(wsapp, message):
        ...
        for pair in range(0,len(ourpairs)):
            ...
            for i in item_generator(rec, "s"):
                if i == needed_pair:
                    ...
                    #price_array[pair][4] = str(ist_epoch)
                    binance_prices = {
                    ...
                    #print("Getting the length of the dictionary in {} bytes".format(sys.getsizeof(binance_prices)))
                #else:
    ...
    #smd_prices["binance_feed"] = price_array
    #print(smd_prices)
   

if __name__ == "__main__":
    #atexit.register(lambda: wsapp.close())
    print('Binance Feed to Database - Please do not kill process')

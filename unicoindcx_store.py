...
if __name__ == "__main__":
	print("Unicoindcx store in db.. Do not kill")
	while True:
		# Define the URL
			...
			try:
				...
				for data in prices_and_quantities:
					...
					if data['symbol'] == needed_pair:
						...
						unicoindcx_prices = {
						"ExchangeName" : "UnicoinDCX",
						"PriceTimeStamp" : ist_time,
						"Pair" : ourpairs[pair],
						"Last" : price_array[pair][1],
						"Ask"  : price_array[pair][2],
						"Bid"  : price_array[pair][3]
						}
						if price_array[pair][1] != 0.0 :
							new_price_entry = Prices.insert_one(unicoindcx_prices)
